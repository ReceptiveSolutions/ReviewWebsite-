...
function Footer() {
  ...
  const footerLinkClass = "text-amber-100 hover:text-white transition-colors duration-300 hover:underline";
  const socialIconClass = "w-6 h-6 text-amber-100 hover:text-white transition-colors duration-300 hover:scale-110 transform";

  return (
    <footer className="bg-gradient-to-b from-amber-500 to-amber-600 mt-auto">
      {/* Main Footer Content */}
      <Container>
        <div className="py-12">
          {/* Top Section */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center mb-4">
                <Logo className="h-10 w-auto text-white filter drop-shadow-lg" />
              </div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="p-2 rounded-lg hover:bg-[#b45309]/50 transition-colors duration-300">
          ...
          {/* Newsletter Signup */}
          <div className="bg-[#b45309]/30 rounded-xl p-6 mb-8">
            <div className="max-w-2xl mx-auto text-center">
              <h3 className="text-white font-semibold text-xl mb-2">Stay Updated</h3>
              <p className="text-amber-100 mb-4">Subscribe to our newsletter for the latest reviews and updates.</p>
              <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="flex-1 px-4 py-2 rounded-lg border-0 focus:outline-none focus:ring-2 focus:ring-white/50 bg-white/90 text-gray-800 placeholder-gray-500"
                />
                <button className="bg-[#b45309] hover:bg-[#9a4607] text-white px-6 py-2 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg whitespace-nowrap">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-2">
                <svg className="w-4 h-4 text-amber-100" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                </svg>
                <span className="text-amber-100 text-sm">Trusted Reviews</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg className="w-4 h-4 text-amber-100" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zM9 6c0-1.66 1.34-3 3-3s3 1.34 3 3v2H9V6z"/>
                </svg>
                <span className="text-amber-100 text-sm">Secure Platform</span>
              </div>
            </div>
          </div>
        </Container>
