  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-amber-25 to-white p-4 md:p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Smile emojis */}
        <div className="absolute top-40 left-20 text-6xl opacity-20 rotate-12">
          <Star className="w-full h-full" />
        </div>
        <div className="absolute top-20 right-32 text-4xl opacity-15 -rotate-12">
          <Pencil className="w-full h-full" />
        </div>
        <div className="absolute top-60 left-2/3 text-5xl opacity-18 rotate-6">
          🙂
        </div>
        ...
        <div className="absolute top-1/3 left-16 text-5xl opacity-15 rotate-45">
          <Star className="w-full h-full" />
        </div>
        <div className="absolute top-2/5 right-20 text-4xl opacity-20 -rotate-30">
          <Pencil className="w-full h-full" />
        </div>
        <div className="absolute top-1/2 right-1/3 text-6xl opacity-12 rotate-15">
          😌
        </div>
        ...
        {/* Bottom smile emojis */}
        <div className="absolute bottom-32 left-32 text-5xl opacity-18 rotate-30">
          <Star className="w-full h-full" />
        </div>
        <div className="absolute bottom-20 right-24 text-4xl opacity-22 -rotate-20">
          <Pencil className="w-full h-full" />
        </div>
        <div className="absolute bottom-40 left-2/3 text-6xl opacity-15 rotate-45">
          🥰
        </div>
        <div className="absolute bottom-60 right-8 text-5xl opacity-20 -rotate-15">
          <Pencil className="w-full h-full" />
        </div>
        ...
        <div className="absolute top-80 right-1/2 text-4xl opacity-16 rotate-20">
          <Pencil className="w-full h-full" />
        </div>
        <div className="absolute bottom-80 left-1/2 text-5xl opacity-19 -rotate-25">
          🤩
        </div>
        <div className="absolute top-1/4 left-8 text-3xl opacity-22 rotate-35">
          <Pencil className="w-full h-full" />
        </div>
        <div className="absolute bottom-1/4 right-12 text-4xl opacity-14 -rotate-40">
          🥳
        </div>
